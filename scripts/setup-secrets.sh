...
# ============================================
# Generated by scripts/setup-secrets.sh on $(date)
...
echo -e "  ${BLUE}•${NC} Docker Compose: ${GREEN}docker-compose -f infrastructure/docker-compose/docker-compose.yml up${NC}"
echo -e "  ${BLUE}•${NC} Kubernetes: ${GREEN}kubectl apply -f infrastructure/k8s/base/generator/secret.yaml${NC}"
echo ""
