...
def test_document_processing_service_uses_semantic_chunking():
    """Test that document processing service uses semantic chunking"""
    # DocumentProcessingService now always uses SemanticChunkerV2
    ...
    # Verify semantic chunking is being used (SemanticChunkerV2)
